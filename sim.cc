...
int main(int argc, char** argv)//main take directly argc and argv from the command line -> ./sim ciccio.mac -> argc = 2, argv = {./sim, ciccio.mac}. argv[1]=ciccio.mac. Note: char** argv = char* argv[]
{
    ...
    // ######## This is the real simulation architecture construction 
        ...
        //First: construction -> creates detector 
